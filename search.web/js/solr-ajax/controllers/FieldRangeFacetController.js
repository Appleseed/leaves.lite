...
/*---------------------------------------------------------------------------*/
/* FieldRangeFacetController                                                  */

/**
 * Facet field range query controller. Fetches a list of facet values from the search
 * index for the specified date or int field. When a facet value is selected by the user, a
 ...
 */
function FieldRangeFacetController($scope, $attrs, $location, $route, $routeParams, $window, SolrSearchService) {
    ...
    // the name of the field range to facet
    $scope.field = '';
