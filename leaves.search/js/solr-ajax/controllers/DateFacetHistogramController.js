...
function DateFacetHistogramController($scope, $attrs, $location, $log, $route, $routeParams, SolrSearchService, Utils) {
    ...
    $scope.init = function() {
        ...
        $scope.$on("$routeChangeSuccess", function() {
            ...
            var startDateQuery = SolrSearchService.createQuery($rootScope.appleseedsSearchSolrProxy);
            ...
            var endDateQuery = SolrSearchService.createQuery($rootScope.appleseedsSearchSolrProxy);
    ...
    $scope.updateHistogram = function () {
        ...
        for (var i=0;i<$scope.histogram.length;i++) {
            ...
            var histogramQuery = SolrSearchService.createQuery($rootScope.appleseedsSearchSolrProxy);
